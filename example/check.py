...
# Plot the cost vs height with x and y coordinates swapped
plt.figure()
plt.scatter(-Z2, Z1, s=0.5)  # Swapped x and y coordinates
plt.xlabel('Height')  # Label height on x-axis
plt.ylabel('Cost')    # Label cost on y-axis
plt.title('Height vs Cost')  # Change the title accordingly
plt.show()
